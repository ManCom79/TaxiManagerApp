...
namespace Models
{
    public class Driver : User
    {
        ...
        public Driver(int id, string firstName, string lastName, string userName, string password, string driverLicenseNumber, DateTime licenseExpiryDate) : base(id, firstName, lastName, userName, password, RoleEnums.Driver)
        {
